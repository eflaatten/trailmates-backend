...
exports.createTrip = async (req, res) => {
  ...
  try {
    ...
    Include:
    1. Recommend stops for food along the route with a clickable OpenStreetMap link for each stop (do NOT use shortened links).
    ...
    Provide full URLs only for OpenStreetMap links.`;
